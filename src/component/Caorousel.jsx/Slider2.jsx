    ...
    return (
        ...
        <div className='col-span-1 my-auto mx-auto '> 
          <Slide direction='up'> <p className='text-[rgb(253,106,146)] '>Hot deal i this Week</p></Slide> 
           <Slide  direction='up' duration='500'> <p className='lg:text-7xl md:text-4xl text-2xl text-black font-medium '>Sony  Smart Gps watch</p></Slide>
...
<Slide duration='2000' direction='up'><img src={banner2} alt="" /></Slide>
<Slide duration='3000' direction='up'><img className=' w-[200px] top-0 mt-20' src={banner1} alt="" /></Slide>
        </div>
    </div>
    );
};

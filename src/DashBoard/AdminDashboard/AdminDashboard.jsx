...
<div className='hover:bg-gray-200 flex hover:text-blue-700  rounded-md mb-3 mt-14 mx-10 py-3 px-3 font-sans  text-[rgb(119,119,119)] text-2xl'><p className='my-auto'><CiShoppingBasket/></p><p className='ms-4'>Manage Seller</p></div>
<div className='hover:bg-gray-200 flex hover:text-blue-700  rounded-md my-3 mx-10 py-3 px-3 font-sans text-[rgb(119,119,119)] text-2xl'><p className='my-auto'><BsCartCheckFill/></p><p className='ms-4'>Manage Products</p></div>
...
<div className='hover:bg-gray-200 flex hover:text-blue-700  rounded-md my-3 mx-10 py-3 px-3 font-sans text-[rgb(119,119,119)] text-2xl'><p className='my-auto' ><VscAccount/></p><p className='ms-4'>All user</p></div>

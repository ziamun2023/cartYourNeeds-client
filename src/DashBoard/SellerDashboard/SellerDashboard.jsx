...
const SellerDashboard = () => {
    ...
    return (
        <div  className='grid  lg:grid-cols-6 gap-5 '>
            ...
            <Slide>  <Link to='/SellerAccount/addnewProduct'><div  className='text-black hover:bg-gray-200 flex hover:translate-x-5 duration-500 hover:shadow-2xl hover:text-blue-700  rounded-md mb-3 mt-14 mx-2 py-3 px-3 font-sans   text-2xl'><p className='my-auto'><CiShoppingBasket/></p><p className='ms-4'>Add a new Item</p></div></Link></Slide>
          
<Slide><Link to='/SellerAccount/sellerproducts'><div  className='text-black hover:bg-gray-200 flex hover:text-blue-700  rounded-md my-3  hover:translate-x-5 duration-500 hover:shadow-2xl mx-2 py-3 px-3 font-sans  text-2xl'><p className='my-auto'><BsCartCheckFill/></p><p className='ms-4'>My Products </p></div></Link></Slide>
<Slide><div className='text-black hover:bg-gray-200 flex hover:text-blue-700  rounded-md my-3  hover:translate-x-5 duration-500 hover:shadow-2xl mx-2 py-3 px-3 font-sans  text-2xl'><p className='my-auto'><BsCartCheckFill/></p><p className='ms-4'>Total orders</p></div></Slide>
...
<Slide><div className='text-black hover:bg-gray-200 flex hover:text-blue-700  rounded-md my-3  hover:translate-x-5 duration-500 hover:shadow-2xl mx-2 py-3 px-3 font-sans  text-2xl'><p className='my-auto' ><VscAccount/></p><p className='ms-4'>Account Details</p></div></Slide>
